"""Regression checks for the watch-model-forecast-probe casebook."""
...
from casebook.harness import assert_expected, watch_model_forecast_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_model_forecast_probe_summary(), assert_expected())
